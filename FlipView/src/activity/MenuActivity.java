...
//			 Article List 로돌아가야하는데 카테고리를 변경해야한다.
			...
			ArticleListActivity articleListActivity = (ArticleListActivity) ArticleListActivity.getInstance();
			...
			Intent intent = new Intent(MenuActivity.this, ArticleListActivity.class);
			
			bun.putInt("category", category);
