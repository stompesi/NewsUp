package com.example.flipview.application;
...
import com.example.flipview.activity.SettingActivity;
...
public class NewsUpApp extends com.orm.SugarApp {
	...
	public void setTextSize(int num) {
		...
		case SettingActivity.SMALL_WORD:
			textSize = R.dimen.text_small;
			pref.setValue(RbPreference.WORD_SIZE, SettingActivity.SMALL_WORD);
			break;
		case SettingActivity.MEDIUM_WORD:
			textSize = R.dimen.text_medium;
			pref.setValue(RbPreference.WORD_SIZE, SettingActivity.MEDIUM_WORD);
			break;
		case SettingActivity.LARGE_WORD:
			textSize = R.dimen.text_large;
			pref.setValue(RbPreference.WORD_SIZE, SettingActivity.LARGE_WORD);
			break;
		}
	}
